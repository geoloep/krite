...
var InspectorApp = (function (_super) {
    ...
    InspectorApp.prototype.createRactive = function (element) {
        ...
        this.ractive.on('select-box', function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!this.draw) return [3 /*break*/, 2];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        console.log(feature);
                        if (!(this.service.layer.hasOperations && this.service.layer.intersects)) return [3 /*break*/, 4];
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        _a = this.loadFeatureCollection;
