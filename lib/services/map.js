...
var MapService = (function () {
    function MapService(element) {
        ...
        this.minZoom = 3;
        this.maxZoom = 16;
        this.initialCenter = [52.156, 5.389];
        this.initialZoom = 4;
        this.clickHandlers = [];
    ...
    MapService.prototype.addHighlight = function (geojson) {
        if (this.highlight) {
            this.highlight.remove();
        }
        var reprojected = reproject.toWgs84(geojson, rd.projection.proj4def);
    ...
    MapService.prototype.zoomToPoint = function (point, zoom) {
        var reprojected = rd.projection.unproject(L.point(point[0], point[1]));
