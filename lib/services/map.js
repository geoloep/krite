...
var MapService = (function () {
    function MapService(element, customOptions) {
        ...
        this.checkZoom = function () {
            ...
            for (var _i = 0, _a = _this.layers; _i < _a.length; _i++) {
                var layer = _a[_i];
                var visible = _this.visibleOnZoom(layer, zoom);
                if (visible && !_this.map.hasLayer(layer.leaflet)) {
                    _this.showLayer(layer);
                }
                else if (!visible && _this.map.hasLayer(layer.leaflet)) {
                    _this.hideLayer(layer);
                }
            }
        };
    ...
    MapService.prototype.visibleOnZoom = function (layer, zoom) {
        if (layer.maxZoom) {
     ...
     */
    MapService.prototype.zoomToPoint = function (point, zoom, marker) {
     ...
     */
    MapService.prototype.zoomToWgsPoint = function (point, zoom, marker) {
        if (marker === void 0) { marker = true; }
        if (marker) {
